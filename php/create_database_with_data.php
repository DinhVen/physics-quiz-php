<?php
    ...
    for ($i = 10; $i <= 12; $i++) {
        for ($j = 1; $j <=7; $j++) {
				...
				mysqli_query($conDB, "DROP TABLE IF EXISTS ques_".$i."_".$j);
			...
			// Vòng lặp trên chưa bao hết toàn bộ các chương của môn này, vì vậy cần thêm 1 lần tạo bảng ở đây
			mysqli_query($conDB, "DROP TABLE IF EXISTS ques_12_8");
    ...
    if (mysqli_query($conDB, "DROP TABLE IF EXISTS tb_admin")) {
